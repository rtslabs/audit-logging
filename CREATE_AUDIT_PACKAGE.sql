...
( 	
 	PARTITION AUDIT_Q1_2016 VALUES LESS THAN (TO_DATE('01-APR-2016','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q2_2016 VALUES LESS THAN (TO_DATE('01-JUL-2016','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q3_2016 VALUES LESS THAN (TO_DATE('01-OCT-2016','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q4_2016 VALUES LESS THAN (TO_DATE('01-JAN-2017','dd-MON-yyyy')),
 	PARTITION AUDIT_Q1_2017 VALUES LESS THAN (TO_DATE('01-APR-2017','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q2_2017 VALUES LESS THAN (TO_DATE('01-JUL-2017','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q3_2017 VALUES LESS THAN (TO_DATE('01-OCT-2017','dd-MON-yyyy')), 
 	PARTITION AUDIT_Q4_2017 VALUES LESS THAN (TO_DATE('01-JAN-2018','dd-MON-yyyy'))
);
...
(
  ...
  CONSTRAINT FK_AUDIT_MASTER_AUDIT_ID FOREIGN KEY (AUDIT_ID) REFERENCES AUDIT_MASTER(AUDIT_ID)
)
PARTITION BY REFERENCE (FK_AUDIT_MASTER_AUDIT_ID);
